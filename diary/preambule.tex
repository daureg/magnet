...
\usepackage[backref=true,citestyle=authoryear-comp,bibstyle=ieee,isbn=false,maxcitenames=1,mincitenames=1,sorting=nyt,backend=biber,defernumbers=true]{biblatex}
