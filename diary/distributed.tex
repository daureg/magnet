...
show that Pregel+ and GPS have better overall performance than Giraph and
GraphLab.}
...
More system in session graph processing of HPDC'14 The 23rd International
...
Breadth First Search, Collaborative Filtering, Triangle Counting. They
quantify the overhead introduced by these framework by implementing hand tuned
native solution.  These abstraction makes the tasks slower by a factor $1.1$
to $568$ in some Giraph cases.
...
using algebrisation \autocite{Kaski2014}) and complexity
\autocite{ComputationBounds14}.
